...
- 盘点 ID：inv-b4d4b82f533bbc54
- 原路径：`%CODEX_HOME%/skills/huashu-topic-gen/SKILL.md`
- SKILL.md SHA-256：`0726a2b638489b7982679e5c2fca9d7121636b96ac055136d9a653deef7bc987`
- 描述：快速生成3-4个选题方向，含标题、大纲和优劣分析。当用户提到"选题"、"写什么"、"文章方向"、"题目建议"时使用。
- 声明版本：1.0.0
- 声明作者：待核实；原创归属未核实
- 许可证声明：待核实；未核验
