...
- 盘点 ID：inv-ad212dca050ba5d8
- 原路径：`%CODEX_HOME%/skills/baoyu-article-illustrator/SKILL.md`
- SKILL.md SHA-256：`df807213cc861837c1e5cfd0eb6ae4161d6c1407659c7d984f3f1065332d63a3`
- 描述：Analyzes article structure, identifies positions requiring visual aids, generates illustrations with Type × Style × Palette three-dimension approach. Use when user asks to "illustrate article", "add images", "generate images for article", or "为文章配图".
- 声明版本：1.0.0
- 声明作者：待核实；原创归属未核实
- 许可证声明：待核实；未核验
