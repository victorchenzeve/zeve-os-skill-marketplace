...
- 盘点 ID：inv-a5f5235d340b6640
- 原路径：`%CODEX_HOME%/skills/seedance-vocab-zh/SKILL.md`
- SKILL.md SHA-256：`155681907696b35a30cc7c471da6a98366b42ba0b1c1ca8787a4cdf5fcfa9abf`
- 描述：This skill should be used when the user asks for Chinese Seedance 2.0 prompt wording, Mandarin cinematic vocabulary, Chinese prompt compression, or translation of camera, lighting, action, VFX, audio, and production terms into Chinese.
- 声明版本：1.0.0
- 声明作者：待核实；原创归属未核实
- 许可证声明：待核实；未核验
