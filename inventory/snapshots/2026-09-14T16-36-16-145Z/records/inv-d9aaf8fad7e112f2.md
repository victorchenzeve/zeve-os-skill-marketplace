...
- 盘点 ID：inv-d9aaf8fad7e112f2
- 原路径：`%CODEX_HOME%/skills/invoice/SKILL.md`
- SKILL.md SHA-256：`e18f802c94bd722e7300e97c0bd939d352234002a66b2709c193c2195b4e6c8e`
- 描述：标准发票: 寄件/收件 + 明细 + 税 + 总额 + 付款指引
- 声明版本：1.0.0
- 声明作者：待核实；原创归属未核实
- 许可证声明：待核实；未核验
