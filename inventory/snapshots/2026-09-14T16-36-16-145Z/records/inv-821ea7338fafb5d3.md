...
- 盘点 ID：inv-821ea7338fafb5d3
- 原路径：`%CODEX_HOME%/skills/huashu-slides/SKILL.md`
- SKILL.md SHA-256：`ae2a9664e8945d4cfb95513101e6fcb87c88c31bb02b34f458ffda06efff52a4`
- 描述：从内容到成品PPTX的端到端演示文稿制作，含AI插画生成和18种设计风格。当用户提到"做PPT"、"做幻灯片"、"演示文稿"、"Keynote"、"slides"时使用。
- 声明版本：1.0.0
- 声明作者：待核实；原创归属未核实
- 许可证声明：待核实；未核验
