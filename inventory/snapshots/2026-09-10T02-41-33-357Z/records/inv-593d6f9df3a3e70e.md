...
- 盘点 ID：inv-593d6f9df3a3e70e
- 原路径：`%CODEX_HOME%/skills/dating-web/SKILL.md`
- SKILL.md SHA-256：`ed98cb19bfba9d056d22d2a3bb432b443888ff84653d6947c96ea51451a8fe4a`
- 描述：消费感配对仪表板: 信号 ticker + KPI + 30 天柱状 + 趋势
- 声明版本：1.0.0
- 声明作者：待核实；原创归属未核实
- 许可证声明：待核实；未核验
