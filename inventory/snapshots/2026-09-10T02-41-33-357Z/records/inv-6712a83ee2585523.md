...
- 盘点 ID：inv-6712a83ee2585523
- 原路径：`%EXTRA_ROOT_2%/一心文件夹/dagu-knowledgebase-resources/repos/mcncarl--yichen-skills/yichen-x-slicer/SKILL.md`
...
- 负责人：待指定
- 相同 SKILL.md 内容记录：[inv-88630f8fd026c2ab](inv-88630f8fd026c2ab.md)
