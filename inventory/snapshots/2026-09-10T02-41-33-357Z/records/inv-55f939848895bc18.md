...
- 盘点 ID：inv-55f939848895bc18
- 原路径：`%EXTRA_ROOT_1%/.codex/.tmp/plugins-backup-5wQAez/repo/plugins/twilio-developer-kit/skills/twilio-whatsapp-send-message/SKILL.md`
...
- 负责人：待指定
- 相同 SKILL.md 内容记录：[inv-5ccfd4e9ddce9a85](inv-5ccfd4e9ddce9a85.md)
