...
- 盘点 ID：inv-a71c7d02107f17a6
- 原路径：`%EXTRA_ROOT_1%/AppData/Roaming/kimi-desktop/daimon-share/daimon/skills/churn-prevention/SKILL.md`
...
- 负责人：待指定
- 相同 SKILL.md 内容记录：[inv-392b3a37a0d5836f](inv-392b3a37a0d5836f.md)
