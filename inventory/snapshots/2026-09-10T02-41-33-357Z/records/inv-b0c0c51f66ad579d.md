...
- 盘点 ID：inv-b0c0c51f66ad579d
- 原路径：`%CODEX_HOME%/skills/seedance-vfx/SKILL.md`
- SKILL.md SHA-256：`16a1b6eb875eca28c89d845c7a639bc4324cc2f4905fedd06137da7f611c0092`
- 描述：This skill should be used when the user asks for VFX, particles, energy, destruction, transformation, weather effects, magical effects, explosions, smoke, fire, water, or physically plausible effects in Seedance 2.0.
- 声明版本：1.0.0
- 声明作者：待核实；原创归属未核实
- 许可证声明：待核实；未核验
