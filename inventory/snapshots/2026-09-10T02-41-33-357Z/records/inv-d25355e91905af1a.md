...
- 盘点 ID：inv-d25355e91905af1a
- 原路径：`%CODEX_HOME%/skills/magazine-poster/SKILL.md`
- SKILL.md SHA-256：`ba76ad65cfb628989c79acd1ab218ca647a31a78d8f4647d8ed91435ec3ccbd2`
- 描述：Sunday-paper 风格, 大字 serif headline + 双栏正文 + 编号 sections
- 声明版本：1.0.0
- 声明作者：待核实；原创归属未核实
- 许可证声明：待核实；未核验
